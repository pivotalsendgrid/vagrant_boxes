...
#
user node['go_segment_base_box']['vagrant']['user'] do
  home node['go_segment_base_box']['vagrant']['home']
  password node['go_segment_base_box']['vagrant']['password']
...
directory "#{node['go_segment_base_box']['vagrant']['home']}/.ssh" do
  owner node['go_segment_base_box']['vagrant']['user']
  group node['go_segment_base_box']['vagrant']['user']
  mode 00700
end

remote_file "#{node['go_segment_base_box']['vagrant']['home']}/.ssh/id_rsa" do
  owner node['go_segment_base_box']['vagrant']['user']
  group node['go_segment_base_box']['vagrant']['user']
  mode 00600
...
remote_file "#{node['go_segment_base_box']['vagrant']['home']}/.ssh/authorized_keys" do
  owner node['go_segment_base_box']['vagrant']['user']
  group node['go_segment_base_box']['vagrant']['user']
  mode 00600
